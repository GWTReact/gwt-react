...
@JsType
public abstract class PureComponentWithContext<P extends BaseProps, C extends BaseContext, S> extends NativePureComponent<P, C, S> {
	@JsConstructor
	protected PureComponentWithContext(P props, C context, JsProcedure updater) {
